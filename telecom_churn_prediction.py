...
Original file is located at
    https://colab.research.google.com/drive/13V3ALTA49umDaJQ6342_e05GoNMuI6Mu
...
for column in col:
    if column in df.columns:  # Ensure the column exists in the DataFrame
        ...
        print(f"  Unique Values: {unique_values[:10]}... (total={len(unique_values)})")  # Show only first 10 unique values
